...
if (id['match'](/^[A-Za-z0-9_.]+$/) != null) {
    ...
    function product(prodi) {
        if (prodi['result']) {
            ...
            spinprefix = ['Ebook', 'e-Book', 'Book', 'PDF', 'd0wnload', 'Read', 'Fre3\x20Pdf', 'Download', 'Book\x20Depository'],
